...
class ChartBuilder {
    constructor({ data, labels, startAtZero = true, height, width, hasXAxisLabels = true, hasYAxisLabels = true, xAxisLabelCount, xAxisLabelStyle, yAxisLabelStyle, hasXAxisBackgroundLines = true, hasYAxisBackgroundLines = true, xAxisBackgroundLineStyle = {
        strokeWidth: 1,
        color: '#000000'
    ...
    renderXAxisLines() {
        ...
        return [...new Array((this.xAxisLabelCount || 4) + 1)].map((_, i) => {
            return (React.createElement("line", { key: Math.random(), x1: this.leftAlignedXAxisLabelWidth, x2: this.width - (this.leftAlignedXAxisLabelWidth ? 0 : this.xAxisLabelWidth), y1: this.yDistanceBetweenXLabels * i, y2: this.yDistanceBetweenXLabels * i, stroke: color, strokeDasharray: '5, 10', strokeWidth: strokeWidth }));
        });
    }
    renderYAxisLines() {
        let color = '#00000';
        ...
        return [...new Array(Math.ceil(this.data.length))].map((_, i) => {
            return (React.createElement("line", { key: Math.random(), x1: (i * this.yLabelSlotWidth) + (this.yLabelSlotWidth / 2) + this.leftAlignedXAxisLabelWidth, x2: (i * this.yLabelSlotWidth) + (this.yLabelSlotWidth / 2) + this.leftAlignedXAxisLabelWidth, y1: 0, y2: this.baseHeight, stroke: color, strokeDasharray: '5, 10', strokeWidth: strokeWidth }));
        });
    }
    renderXAxisLabels() {
        let xOffset = 0;
